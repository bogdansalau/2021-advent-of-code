...
class SeatingSystem(val input: List<String>) {
    ...
    fun solvePart1(): Int = findStableMap(4, this::countImmediateNeighbors)

    fun solvePart2(): Int = findStableMap(5, this::countDirectionalNeighbors)
    ...
    private fun countDirectionalNeighbors(seats: Seats, seat: Seat): Int =
        neighbors
            .mapNotNull { seatOnVector(seats, seat, it) }
            .count { it == '#' }

    private fun seatOnVector(seats: Seats, seat: Seat, vector: Seat): Char? =
